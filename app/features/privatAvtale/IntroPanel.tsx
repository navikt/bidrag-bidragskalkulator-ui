...
const tekster = definerTekster({
  innhold1: {
    ...
    nn: "Dette skjemaet kan de bruke når de skal inngå privat avtale om barnebidrag for barn under 18 år.",
  },
  innhold2: {
    ...
    nn: "Nav blir ikkje involvert når de inngår ein privat avtale. Dersom de ønsker at Skatteetaten skal krevje inn og utbetale allereie avtalt barnebidrag, må de sende gjeldande private avtale til Nav. Vi tek det så vidare med Skatteetaten.",
  },
  lenkeTilKalkulator: {
    nb: "Bruk kalkulatoren for å bestemme barnebidrag",
    en: "Use the calculator to determine child support",
    nn: "Bruk kalkulatoren for å bestemme barnebidrag",
  },
});

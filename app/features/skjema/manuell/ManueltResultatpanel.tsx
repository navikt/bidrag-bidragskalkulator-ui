...
const tekster = definerTekster({
  ...
  bidragetSkalDekke: {
    ...
    beskrivelse1: {
      nb: "Når dere inngår en privat avtale om barnebidrag, bestemmer dere selv hva bidraget skal dekke. Som et minimum må bidraget dekke kostnadene ved å forsørge barnet i hverdagen, også kalt underholdskostnadene.",
      ...
      nn: "Når de inngår ein privat avtale om barnebidrag, bestemmer de sjølve kva bidraget skal dekke. Som eit minimum må bidraget dekke kostnadane ved å forsørgje barnet i kvardagen, også kalla underhaldskostnadar.",
    },
    listeIntro: {
      nb: "Dette inkluderer:",
      en: "This includes:",
    ...
    beskrivelse2: {
      nb: "Det er underholdkostnadene Nav tar utgangspunkt i når vi fastsetter bidraget.",
      en: "It is the maintenance costs that Nav uses as a basis when determining the support.",
      nn: "Det er underhaldskostnadene Nav tek utgangspunkt i når vi fastset bidraget.",
    },
    lesMer: {
